...
class Client
{
    ...
    /**
     * Import/Export the server definitions - exchanges, queues, bindings, users, virtual hosts, permissions and parameters.
     * Everything apart from messages.
     *
     * For imports, note that:
    ...
    {
        return new Api\Definitions($this);
    }
     ...
     * @return Api\Shovel
     */
    public function shovels()
    {
        return new Api\Shovel($this);
    }
